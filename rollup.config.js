		...
		plugins: [
			...
			copy({
				targets: [
					...
					{
						src: 'node_modules/bootstrap/dist/**/*.min.js',
						dest: 'static/vendor/bootstrap'
					},
					{
						src: 'node_modules/bootstrap/dist/**/*.min.css',
						dest: 'static/vendor/bootstrap'
					},
					{
						src: 'node_modules/datatables.net-bs4/**/*.min.*',
						dest: 'static/vendor/datatables.net-bs4'
					},
				]
			}),
			resolve({
